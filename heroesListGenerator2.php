...
function getList(){
  ...
  $html = file_get_contents('https://web.archive.org/web/20191008052401/http://krosfinder.com/de/editions');
  $dom = new HTML5();
