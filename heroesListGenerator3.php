...
function getList(){
  ...
  $html = file_get_contents('https://web.archive.org/web/20191008052758/http://krosfinder.com/pt/editions');
  $dom = new HTML5();
